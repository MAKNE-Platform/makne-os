...
export default function CreatorProfileView({
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 space-y-12">
      ...
      <div className="rounded-2xl border border-white/10 bg-[#0F1117] p-6 space-y-5">

        <div className="flex items-center justify-between">

          <h2 className="text-lg font-medium">
            MAKNE Recommendation Insight
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <MetricCard
            label="Completion"
            value={`${recommendation.metrics.completionRate}%`}
          />

          <MetricCard
            label="Avg Revisions"
            value={recommendation.metrics.avgRevisions}
          />

          <MetricCard
            label="Repeat Brands"
            value={`${recommendation.metrics.repeatBrandsPercent}%`}
          />

          <MetricCard
            label="Turnaround"
            value={`${recommendation.metrics.avgTurnaround}d`}
          />
        </div>
